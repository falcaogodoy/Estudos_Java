...
public class App {
    ...
    public static void main(String args[]){
        ...
        String opcao = JOptionPane.showInputDialog(null, "Digite 1 parada cadastro, 2 para consultar, 3 para excluir, 4 para alterar ou 5 para sair","cadastro", JOptionPane.INFORMATION_MESSAGE );
